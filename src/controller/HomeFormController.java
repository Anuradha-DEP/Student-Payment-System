...
public class HomeFormController {
    ...
    public JFXRippler rprAddPayment;
    public AnchorPane pneAddPayment;
    ...
    public void pneAddPayment_OnKeyPress(KeyEvent keyEvent) {
        if (keyEvent.getCode() == KeyCode.ENTER || keyEvent.getCode() == KeyCode.SPACE) {
            navigate("Add Payment", "/view/PaymentForm.fxml");
        }
    }

    public void pneAddPayment_OnKeyReleased(KeyEvent keyEvent)  throws IOException{
        if (keyEvent.getCode() == KeyCode.ENTER || keyEvent.getCode() == KeyCode.SPACE) {
            navigate("Add Payment", "/view/PaymentForm.fxml");
        }
    }

    public void pneAddPayment_OnMouseClicked(MouseEvent mouseEvent) throws IOException {
        navigate("Add Payment", "/view/PaymentForm.fxml");
    }
}
