    ...
    public void initialize() {
        ...
        Platform.runLater(() -> {
            ...
            if (root.getUserData() != null) {
                ...
                String userData = (String) this.root.getScene().getUserData();

                if(userData.equals("update")){
                    ...
                    lblTitle.setText("View Student");
                    imgLogo.setImage(new Image("/view/assets/Search Client.png"));
                }
